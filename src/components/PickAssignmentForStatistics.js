...
const PickAssignmentForStatistics = (props) => {
  ...
  return (
    <div>
      <Container className={classes.container}>
          <form>
              <h3 style={{paddingLeft: ".9em"}}>Choose an assignment to view statistics</h3>
                ...
                <div style={assignmentObjects.length>0 ? {} : {display: "none"}}>
                  {assignmentObjects.map((data, index) => (
                    <div style={{padding: ".3em"}} key={index}>
                      <a style={{textDecoration: "none"}} href={"/stats?assignment=" + assignmentObjects[index].id}>
                        <Button
...
export default withRouter(PickAssignmentForStatistics)