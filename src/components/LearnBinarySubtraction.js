        ...
        <div className={classes.container}>
            <Container style={{display: "flex", height: "40em"}}>
                <Zoom in={stepCounter === 1} style={stepCounter === 1 ? {} : {display: "none"}}>
                    <div style={{width: "100%"}}>
                        <h3 className={classes.h3}>Subtracting two 4-Bit Numbers</h3>
                ...
                <Zoom in={stepCounter === 3} style={stepCounter === 3 ? {} : {display: "none"}}>
                    <div style={{width: "100%"}}>
                        <h3 className={classes.h3}>Two's Complement</h3>
                        <Paper elevation="3" className={classes.paper}>
                            <p>
                ...
                <Zoom in={stepCounter === 4} style={stepCounter === 4 ? {} : {display: "none"}}>
                    <div style={{width: "100%"}}>
                        <h3 className={classes.h3}>Adding a Negative Number to Subtract</h3>
                        <Paper elevation="3" className={classes.paper}>
                            <p>
                ...
                <Zoom in={stepCounter === 5} style={stepCounter === 5 ? {} : {display: "none"}}>
                    <div style={{width: "100%"}}>
                        <h3 className={classes.h3}>Now Try Subtracting On Your Own</h3>
                        <Paper elevation="3" className={classes.paper}>
                            <p>
                ...
                <Zoom in={stepCounter === 6} style={stepCounter === 6 ? {} : {display: "none"}}>
                    <div style={{width: "100%"}}>
                        <h3 className={classes.h3}>Finding the Complements</h3>
                        <Paper elevation="3" className={classes.paper}>
                            <p>
                ...
                <Zoom in={stepCounter === 7} style={stepCounter === 7 ? {} : {display: "none"}}>
                    <div style={{width: "100%"}}>
                        <h3 className={classes.h3}>Solution</h3>
                        <Paper elevation="3" className={classes.paper}>
                            <p>
